...
.DESCRIPTION
This script unregisters a Windows Fabric application type on a cluster.  It is invoked by Visual Studio when executing the "Unregister Application" command of a Windows Fabric Application project.
